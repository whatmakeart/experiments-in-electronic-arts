...
The only way to improve on a new skill is to practice. This exercise provides soldering practice for wires, through hole components, and srew terminals. We will use inexpesive low quality perfboard for these exercises. Mistakes are likely and it is best to practice with low cost materials before working on projects that are more critical.
...
- Keep the wire pieces short so you don't waste wire. Don't wory if you accidently cut a piece longer than it needs but do your best to not be wasteful.
